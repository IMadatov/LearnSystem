    ...
    where TDtoFull : class, IDataTransferObject<TEntity, TKey>
{
    ...
    Task<ServiceResultBase<QueryResult<TDto>>> GetAllAsync(
    ...
    /// <exception cref="OperationCanceledException" />
    Task<ServiceResultBase<TEntity?>> GetEntityByIdAsync(
        TKey id,
        IUserProfile userProfile,
        Func<IQueryable<TEntity>, IUserProfile, Task<IQueryable<TEntity>>>? customAction = null,
        CancellationToken cancellationToken = default);
    ...
    /// <exception cref="InvalidIdArgumentException" />
    /// <exception cref="OperationCanceledException" />
    Task<ServiceResultBase<TDtoFull?>> GetByIdAsync(
        TKey id,
        IUserProfile userProfile,
        Func<IQueryable<TEntity>, IUserProfile, Task<IQueryable<TEntity>>>? customAction = null,
        CancellationToken cancellationToken = default);
    ...
    /// <exception cref="InvalidIdArgumentException" />
    /// <exception cref="OperationCanceledException" />
    Task<ServiceResultBase<IAsyncEnumerable<TEntity>>> GetEntityListAsync(
        IUserProfile userProfile,
        Func<IQueryable<TEntity>, IUserProfile, Task<IQueryable<TEntity>>>? customAction = null,
        CancellationToken cancellationToken = default);
    ...
    /// <exception cref="OperationCanceledException" />
    /// <exception cref="ArgumentNullException" />
    Task<ServiceResultBase<IAsyncEnumerable<TDto>>> GetListAsync(
        IUserProfile userProfile,
        Func<IQueryable<TEntity>, IUserProfile, Task<IQueryable<TEntity>>>? customAction = null,
        CancellationToken cancellationToken = default);
    ...
    /// </returns>
    /// <exception cref="OperationCanceledException" />
    Task<ServiceResultBase<IAsyncEnumerable<TDtoFull>>> GetFullEntityListAsync(
        IUserProfile userProfile,
        Func<IQueryable<TEntity>, IUserProfile, Task<IQueryable<TEntity>>>? customAction = null,
        CancellationToken cancellationToken = default);
    ...
    /// <exception cref="InvalidIdArgumentException" />
    /// <exception cref="OperationCanceledException" />
    Task<ServiceResultBase<bool>> DeactivateByIdAsync(
        TKey id,
        IUserProfile userProfile,
        Func<IQueryable<TEntity>, IUserProfile, Task<IQueryable<TEntity>>>? customAction = null,
        CancellationToken cancellationToken = default);
    ...
    /// <exception cref="OperationCanceledException" />
    Task<ServiceResultBase<TEntity>> InsertAsync(TEntity entity, CancellationToken cancellationToken = default);
    ...
    /// <exception cref="DatabaseOperationException" />
    /// <exception cref="OperationCanceledException" />
    Task<ServiceResultBase<TDtoFull>> InsertAsync(TDtoFull entity, CancellationToken cancellationToken = default);
    ...
    /// <exception cref="DatabaseOperationException" />
    /// <exception cref="OperationCanceledException" />
    Task<ServiceResultBase<TEntity>> UpdateAsync(TEntity entity, CancellationToken cancellationToken = default);
    ...
    /// <exception cref="DatabaseOperationException" />
    /// <exception cref="OperationCanceledException" />
    Task<ServiceResultBase<TDtoFull>> UpdateAsync(TDtoFull entity, CancellationToken cancellationToken = default);
    ...
    /// <exception cref="ArgumentNullException" />
    /// <exception cref="OperationCanceledException" />
    Task<ServiceResultBase<int>> PatchUpdateAsync(
    ...
    /// <exception cref="ArgumentNullException" />
    /// <exception cref="OperationCanceledException" />
    Task<ServiceResultBase<int>> PatchUpdateAsync<TResult>(
        Expression<Func<TEntity, bool>> predicate,
