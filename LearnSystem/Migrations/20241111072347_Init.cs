        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dagree = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StatusUsers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AtCreate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Active = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Journales", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Journales_Classes_ClassId",
                        column: x => x.ClassId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JournalSubject", x => new { x.JournalsId, x.SubjectId });
                    table.ForeignKey(
                        name: "FK_JournalSubject_Journales_JournalsId",
                        column: x => x.JournalsId,
                        principalTable: "Journales",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JournalSubject_Subjects_SubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JournalTeacher", x => new { x.JournalsId, x.TeachersId });
                    table.ForeignKey(
                        name: "FK_JournalTeacher_Journales_JournalsId",
                        column: x => x.JournalsId,
                        principalTable: "Journales",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JournalTeacher_Teachers_TeachersId",
                        column: x => x.TeachersId,
                        principalTable: "Teachers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassWork = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lessons_Journales_JournalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Journales_ClassId",
                table: "Journales",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_JournalSubject_SubjectId",
                table: "JournalSubject",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_JournalTeacher_TeachersId",
                table: "JournalTeacher",
                column: "TeachersId");
